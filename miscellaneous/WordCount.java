...
public class WordCount {
	public static void main(String args[]) {
		{
			String input = JOptionPane.showInputDialog("Please input words");
			//String input = "Welcome to Java Session Session Session"; // Input
																		// String
			...
			for (int i = 0; i < words.length; i++) // Outer loop for Comparison
			{
				...
				if (words[i] != "0")
					System.out.println(words[i] + "--" + wrc); // Printing the
																// word along
																// with count
				wrc = 1;
